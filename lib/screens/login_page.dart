...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: MediaQuery.of(context).size.height/812*117,),
          Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: MediaQuery.of(context).size.height/812*113,),
                  const Text(
                    '환영합니다!\n\nD-LIVE에서 활동하기 위해서는\n계정생성이 필요해요.',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                  ),
                  SizedBox(height: MediaQuery.of(context).size.height/812*50,),
                  GestureDetector(
                    child: Container(
                  ...
                  SizedBox(height: MediaQuery.of(context).size.height/812*15,),
                  GestureDetector(
                    child: Container(
                      height: MediaQuery.of(context).size.height/812*46,
                      width: MediaQuery.of(context).size.width/375*249,
