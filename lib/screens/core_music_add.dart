  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('내 코어 음악 추가',style: TextStyle(color: Colors.white),),
        centerTitle: true,
        actions: [
          TextButton(onPressed: () {}, child: const Text('확인',style: TextStyle(color: Color(0XFFFFFFFF)),)),
        ],
      ),
      body: Column(
        children: [
          Container(
            ...
            child: Column(
              children: [
                ...
                const Text('최근 검색 내역이 없습니다',style: TextStyle(color: Color(0XFF9C9C9C)),),
                 SizedBox(height: height*0.01,),
                 const Divider(color: Color(0XFFADADAD),),
                 const Text('닫기',style: TextStyle(color: Color(0XFF9C9C9C)),)
              ],
            ),
          ),
        ],
